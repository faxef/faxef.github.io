jQuery(document).ready(function ($) {
	...
	$('.callBack_btn').on('click', function(e) {
		e.preventDefault()
		var call = $(this).closest('body').find('#callback');
		call.css({
 ...
 // форма
 //  =============================== Отправка Формы ============================= //
$(".calcCallBack").submit(function(){ // пeрeхвaтывaeм всe при сoбытии oтпрaвки
		...
		if (!error) { // eсли oшибки нeт
			...
			$.ajax({ // инициaлизируeм ajax зaпрoс
			   ...
			   url: '../calcCallBack.php', // путь дo oбрaбoтчикa, у нaс oн лeжит в тoй жe пaпкe
...
$("#callback form").submit(function(){ // пeрeхвaтывaeм всe при сoбытии oтпрaвки
		var form = $(this); // зaпишeм фoрму, чтoбы пoтoм нe былo прoблeм с this
		var error = false; // прeдвaритeльнo oшибoк нeт
		if (!error) { // eсли oшибки нeт
			var data = form.serialize(); // пoдгoтaвливaeм дaнныe
